...
class Today extends Component {
	...
	componentDidMount() {
		this.props.fetchToday(this.props.today_props)
	}
	...
	render () {
		...
		let orders =   {
		        ...
		        "series":[
		            ...
		            {
		                "values":[(this.props.today_props.completed_orders / this.props.today_props.orders) * 100],
		                "bar-width":"10px",
		                "max-trackers":0,
		                "value-box":{
		                    "placement":"top-out",
			      ...
			      },
			      {
			       ...
			       {
			      	"text": this.props.today_props.orders,
			      	"x":"0px",
		            "y":"39px",
		            "font-color": "#E06E73",
		            "font-size": "15"
			       ...
			       {
			      	"text": this.props.today_props.completed_orders,
			      	"x":"271px",
		            "y":"39px",
		            "font-color": "#E06E73",
		            "font-size": "15"
			...
			<div className="week-container" >
				<div className="barchart">
			     ...
			     <div className="total-sales">
					<h3>Total Sales</h3>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${this.props.today_props.total_sales}</p>
			     </div>
			     ...
			     <div className="sales-number">
			     	<h3>Sales</h3>
			     	<p>&nbsp;&nbsp;&nbsp;{this.props.today_props.orders}</p>
			     </div>
			     <div className="items">
					<table>
						<tbody>
...
function mapStateTpProps(state) {
	return { today_props: state.today_reducer }
}

function mapDispatchToProps(dispatch) {
	return bindActionCreators({ fetchToday: fetchToday }, dispatch)
}

export default connect(mapStateTpProps, mapDispatchToProps)(Today);